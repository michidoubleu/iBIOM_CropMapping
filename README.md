# iBIOM - Crop Distribution Downscaling (CDDS)

## Overview
This repository contains the Crop Distribution Downscaling System (CDDS), an R-based pipeline designed to downscale crop area and production targets to a high-resolution 1 km² EEA reference grid. It utilizes land-use maps (LUM), crop suitability probabilities, and EPIC yield models to produce consistent local allocations. 
